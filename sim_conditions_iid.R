...
n_obs_per_cluster <- rev(c(5, 10, 50, 100, 150)) # number of observations per cluster
...
sigma_rdm_fix_ratio <- rev(c(0))  # random effect beta variance proportional to fixed effects
